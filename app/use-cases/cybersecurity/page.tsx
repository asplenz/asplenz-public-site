...
Rule: "SQL queries must use parameterized statements" (MANDATORY)`,
    sub2Outro: 'Agents query Knowledge before writing code. The CI Compliance Check flags violations if generated code conflicts with a declared constraint.',
...
Rule: "Les requetes SQL doivent utiliser des statements parametres" (MANDATORY)`,
    sub2Outro: 'Les agents interrogent Knowledge avant d\'ecrire du code. Le CI Compliance Check signale les violations si le code genere entre en conflit avec une contrainte declaree.',
