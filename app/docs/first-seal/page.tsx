        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            ...
            {content.whatHappened.verificationLink && (
              <p className="text-sm">
                <Link href="/docs/verification" className="text-[#1A5187] hover:underline">
                  {content.whatHappened.verificationLink}
                </Link>
              </p>
            )}
          ...
          <section className="mb-12">
            ...
            {content.whatHorizonDoesNot.proofSemanticsLink && (
              <p className="text-sm">
                <Link href="/docs/proof-semantics" className="text-[#1A5187] hover:underline">
                  {content.whatHorizonDoesNot.proofSemanticsLink}
                </Link>
              </p>
            )}
          ...
          <PageNav current="/docs/first-seal" />
        </div>
      </main>
