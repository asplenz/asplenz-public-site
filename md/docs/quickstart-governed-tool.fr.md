...
- **[Wrapper votre propre serveur MCP avec enforcement](/docs/guides/wrap-your-own-mcp-server-with-enforcement)** - la même primitive `verify_verdict`, appliquée aux tools exposés en MCP.
