...
# L'Artefact de Snapshot Décisionnel

*Cette page établit la définition canonique et faisant autorité de l'Artefact de Snapshot Décisionnel.*
...
L'Artefact de Persistance Décisionnelle ne décrit pas une décision.
