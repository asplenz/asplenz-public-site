...
export const content = {
  en: {
    ...
    index: {
      ...
      howItWorks: {
        ...
        steps: [
          { label: 'Declare', description: 'A decision is explicitly declared with its context and authority.' },
          { label: 'Capture', description: 'The decision is captured as a structured, attributable fact.' },
          { label: 'Seal', description: 'The record is cryptographically sealed into an append-only proof chain.' },
          { label: 'Verify', description: 'The proof can be independently verified at any time.' },
        ],
        summary: 'Decisions are explicitly declared, cryptographically sealed and independently verifiable. Without changing how teams work.',
      },
      reality: {
        title: 'The reality organizations face',
        p1: 'Every organization makes decisions that carry risk. Some are human. Some are automated. Some are delegated to AI systems.',
        p2: '**Most are not provable.**',
        ...
        conclusion: '**That is not proof. That is exposure.**',
      },
      breaks: {
      ...
      whatDoes: {
        ...
        main: 'Horizon records decisions as facts. Not workflows. Not policies. Not explanations. **Decisions.**',
      ...
      governance: {
        ...
        conclusion: 'Where governance defines *who should* decide, Horizon proves *what* was decided, *by whom*, and *when*.',
      },
      twoFacts: {
        title: 'Two Kinds of Facts. One Proof Chain.',
        intro: 'Horizon preserves two categories of declared facts:',
        facts: [
          '**Decisions:** Facts that engage responsibility (Go-live, risk acceptance, override).',
          '**Evaluations:** Facts that follow (Monitoring results, compliance checks, assessments).',
        ],
        tableHeader: { time: 'Time', type: 'Fact Type', record: 'Record' },
        tableRows: [
          { time: 'T0', type: 'Decision', record: 'Production go-live approved for credit model V2.5' },
          { time: 'T1', type: 'Evaluation', record: 'No anomaly detected after 24 hours' },
          { time: 'T2', type: 'Evaluation', record: 'Minor drift on default rate relative to threshold. Verdict: PASS' },
        ],
      },
      notJudged: {
        title: 'Decisions are not judged. They are proven.',
        intro: 'Horizon does not decide, validate, or enforce rules. It preserves:',
        preserves: [
          '**What** was decided',
      ...
      aiAccountability: {
        title: 'Built for AI accountability',
        intro: 'AI systems amplify risk: decisions scale instantly, context disappears, and responsibility becomes blurred. Horizon provides definitive proof for:',
        proofs: [
      ...
      replaces: {
        ...
        rows: [
          ...
          { before: 'Scattered evidence', after: 'Sealed evaluation timelines' },
        ],
      },
      whoFor: {
      ...
      simpleQuestion: {
        ...
        question2: 'And what happened after -can you prove that too?',
  ...
  fr: {
    ...
    index: {
      hero: {
        subtitle: 'Quand la redevabilité est remise en question.\nLa preuve doit déjà exister.',
        description: 'Horizon est le système d\'enregistrement de référence pour vos décisions critiques.',
        hook: 'Il capture les décisions comme des faits immuables -avant même qu\'elles n\'aient besoin d\'être expliquées.',
      ...
      howItWorks: {
        ...
        steps: [
          { label: 'Déclarer', description: 'Une décision est explicitement déclarée avec son contexte et son autorité.' },
          { label: 'Capturer', description: 'La décision est capturée comme un fait structuré et attribuable.' },
          { label: 'Sceller', description: 'L\'enregistrement est scellé cryptographiquement dans une chaîne de preuve en ajout uniquement.' },
          { label: 'Vérifier', description: 'La preuve peut être vérifiée de manière indépendante à tout moment.' },
        ],
        summary: 'Les décisions sont explicitement déclarées, scellées cryptographiquement et vérifiables de manière indépendante. Sans changer la façon dont les équipes travaillent.',
      },
      reality: {
        title: 'La réalité des organisations',
        p1: 'Chaque organisation prend des décisions porteuses de risques. Certaines sont humaines. D\'autres sont automatisées. Certaines sont déléguées à des systèmes d\'IA.',
        p2: '**La plupart ne sont pas prouvables.**',
        reliance: 'Quand un problème survient, les équipes s\'appuient sur :',
        items: [
        ...
        conclusion: '**Ce n\'est pas de la preuve. C\'est de l\'exposition au risque.**',
      },
      breaks: {
        title: 'Les conséquences de l\'absence de preuve',
        items: [
      ...
      whatDoes: {
        ...
        main: 'Horizon enregistre les décisions comme des faits. Pas des workflows. Pas des politiques. Pas des explications. **Des décisions.**',
        ...
        conclusion: 'Une fois enregistrée, elle ne peut être modifiée, réécrite ou contestée.',
        evalBlock: '**La responsabilité ne s\'arrête pas au moment de la décision.**\nCe qui suit (résultats de monitoring, constats, observations déclarées) est scellé avec les mêmes garanties, lié à la décision originale.\nEnsemble, ils forment une **chronologie scellée de la redevabilité.**',
      },
      governance: {
        title: 'La Gouvernance définit la Responsabilité. Horizon la prouve.',
        p1: 'Les cadres de gouvernance définissent les politiques, les rôles et les modèles de redevabilité.',
        bullets: [
          '**Horizon ne conçoit pas la gouvernance.**',
          '**Horizon enregistre le moment où la responsabilité est assumée.**',
        ],
        conclusion: 'Là où la gouvernance définit *qui doit* décider, Horizon prouve *ce qui a été décidé*, *par qui*, et *quand*.',
      },
      twoFacts: {
        title: 'Deux types de faits. Une seule chaîne de preuve.',
        intro: 'Horizon préserve deux catégories de faits déclarés :',
        facts: [
          '**Décisions :** Les faits qui engagent la responsabilité (Mise en prod, dérogation).',
          '**Évaluations :** Les faits qui suivent (Monitoring, contrôles, constats).',
        ],
        tableHeader: { time: 'Temps', type: 'Type de fait', record: 'Enregistrement' },
        tableRows: [
          { time: 'T0', type: 'Décision', record: 'Mise en production approuvée pour le modèle de crédit V2.5' },
          { time: 'T1', type: 'Évaluation', record: 'Aucune anomalie détectée après 24 heures' },
          { time: 'T2', type: 'Évaluation', record: 'Légère dérive du taux de défaut par rapport au seuil. Verdict : PASS' },
        ],
      },
      notJudged: {
        title: 'Les décisions ne sont pas jugées. Elles sont prouvées.',
        intro: 'Horizon ne décide pas, ne valide pas et n\'applique pas de règles. Il préserve :',
        preserves: [
          '**Ce qui** a été décidé',
        ...
        conclusion: '**C\'est sa neutralité qui rend la preuve opposable.**',
      },
      aiAccountability: {
        title: 'Conçu pour la redevabilité de l\'IA',
        intro: 'Les systèmes d\'IA amplifient les risques : les décisions passent à l\'échelle instantanément, le contexte disparaît et la responsabilité devient floue. Horizon fournit une preuve définitive pour :',
        proofs: [
        ...
        conclusion: '**Horizon permet de maintenir une responsabilité humaine, même lorsque les décisions sont automatisées.**',
      },
      proofNotLogging: {
        title: 'La Preuve n\'est pas la Journalisation',
        columnLogs: 'Logs & Tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Traces opérationnelles', horizon: 'Système d\'enregistrement indépendant' },
          { logs: 'Mutables / Soumis à rotation', horizon: 'Ajout uniquement, signé par cryptographie' },
          { logs: 'Contexte reconstruit après', horizon: 'Contexte scellé au moment de la déclaration' },
          { logs: 'Pour le dépannage', horizon: 'Pour la redevabilité' },
        ],
        conclusion: '**Horizon introduit une séparation des pouvoirs entre la prise de décision et la preuve de la décision.**',
      },
      replaces: {
        title: 'Ce qu\'Horizon remplace',
        rows: [
          { before: 'Approbations par e-mail', after: 'Enregistrements de décision scellés' },
          { before: 'Tickets et commentaires', after: 'Décisions attribuables' },
          { before: 'Reconstruction manuelle', after: 'Preuve immédiate' },
          { before: 'Preuves de suivi éparpillées', after: 'Chronologies d\'évaluation scellées' },
        ],
      },
      whoFor: {
        ...
        personas: [
          ...
          { role: 'Gouvernance des Risques et de l\'IA', description: 'Démontrez votre redevabilité sans dépendre de systèmes fragiles.' },
          { role: 'Audit', description: 'Appuyez-vous sur des preuves indépendantes et vérifiables.' },
          { role: 'Dirigeants', description: 'Réduisez votre exposition à mesure que l\'automatisation progresse.' },
        ],
      },
      beachhead: {
        title: 'Tête de pont : La Responsabilité de l\'IA',
        intro: 'Les systèmes d\'IA amplifient le besoin de preuve. Horizon fournit la couche de preuve *ex-post* requise par le **Règlement sur l\'IA (AI Act) de l\'UE (Art. 12, 14, 26)** pour :',
        proofs: [
      ...
      simpleQuestion: {
        ...
        question: 'Quelle décision devriez-vous prouver demain ?',
        question2: 'Et ce qu\'il s\'est passé après -pouvez-vous le prouver aussi ?',
