...
export const content = {
  en: {
    ...
    horizonPage: {
      ...
      reality: {
        title: 'The Reality Organizations Face',
        intro: 'Every organization makes decisions that carry risk.',
        lines: [
          'Some are automated.',
          'Some involve AI.',
          'Many are **purely human**.',
        ],
        examplesIntro: 'Examples include:',
        examples: [
          'production incidents and service degradation decisions',
          'emergency overrides and crisis actions',
          'acceptance of operational, financial, or clinical risk',
          'go / no-go approvals for deployments',
          'AI and automated system authorizations',
        ],
        questionsIntro: 'When these decisions are later challenged, organizations struggle to answer:',
        questions: [
          'What was actually decided?',
          'Who made the decision, a human or a system?',
          'Under which authority and context?',
          'Can this be proven independently?',
        ],
        conclusion1: 'Decisions exist.',
        conclusion2: '**Proof** often does not.',
      },
      whyNotAcceptable: {
        title: 'Why This Is No Longer Acceptable',
        intro: 'Regulators, courts, auditors, insurers, and boards now ask:',
        quote: 'Show us the decision, exactly as it was declared, at the moment it was taken.',
        appliesIntro: 'This applies to:',
        applies: [
          'crisis and incident management',
          'AI and automated systems',
          'regulated and high-risk operations',
        ],
        conclusion1: 'What matters is no longer explanation.',
        conclusion2: 'What matters is **proof**.',
      },
      insight: {
        title: 'The Insight',
        main: 'A decision is a **first-class fact**.',
        hook: 'If it is not captured at the moment it is declared, it cannot be reliably proven later.',
        proofIntro: 'Proof must be:',
        proofItems: [
          { term: 'native', description: 'captured when the decision is made' },
          { term: 'immutable', description: 'sealed cryptographically' },
          { term: 'independent', description: 'from the systems involved' },
        ],
      },
      solution: {
        title: 'The Solution',
        ...
        description: 'It captures decisions as immutable, cryptographically sealed facts, whether they are made by:',
        sources: [
          'a human',
          'an automated system',
          'or an AI agent',
        ],
        conclusion1: 'Horizon does not govern decisions.',
        conclusion2: 'It governs the **proof of decisions**.',
      },
      whatDoes: {
        title: 'What Horizon Does',
        ...
        items: [
          ...
          'seal it into an immutable proof chain',
          'verify and export it independently at any time',
        ],
        conclusion: 'Once sealed, a decision cannot be altered, rewritten, or disputed.',
      },
      whatDoesNot: {
        title: 'What Horizon Does Not Do',
        intro: 'Horizon does **not**:',
        items: [
          'judge decision quality',
          'validate compliance',
          'enforce policies or workflows',
          'recommend or bias outcomes',
          'replace ITSM, BPM, or governance tools',
        ],
      ...
      howItWorks: {
        title: 'How Horizon Works',
        steps: [
          { step: 'A decision is declared', detail: 'incident response, approval, override, authorization' },
          { step: 'Horizon captures it', detail: 'via API, UI, or integration' },
          { step: 'The decision is sealed', detail: 'and appended to an immutable proof chain' },
          { step: 'A proof artifact is generated', detail: 'independently verifiable and exportable' },
        ],
        conclusions: [
          'No reconstruction.',
      ...
      proofNotLogging: {
        title: 'Proof Is Not Logging',
        intro1: 'Logs and tickets record activity.',
        intro2: 'Horizon records **responsibility**.',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Operational records', horizon: 'Independent system of record' },
          { logs: 'Mutable', horizon: 'Append-only, signed' },
          { logs: 'Context rebuilt later', horizon: 'Context sealed at decision time' },
          { logs: 'Not legally autonomous', horizon: 'Legally defensible proof' },
        ],
        conclusion: 'Horizon introduces a **separation of powers** between decision-making and decision proof.',
      },
      modules: {
        title: 'One Proof Platform. Multiple Domains Demonstrated',
        intro: 'Horizon is a **single proof infrastructure**.',
        subtitle: 'Domain modules are **thin capture layers** over the same proof chain.',
        items: [
          { name: 'AI Governance', description: 'Proof of human decisions about AI and automated systems.' },
          { name: 'ForenAI', description: 'Forensic proof of AI agent actions and execution traces.' },
          { name: 'Decision Gateway', description: 'Machine-to-human decision capture when automation must pause.' },
          { name: 'Health', description: 'Clinical decisions and post-decision facts, with strict data minimization.' },
        ],
        conclusion1: 'Modules are not products.',
        conclusion2: 'They are structured views over the same proof layer.',
      },
      beachhead: {
        title: 'Beachhead: AI Accountability',
        intro: 'AI systems amplify the proof problem:',
        risks: [
          'decisions scale instantly',
          'context disappears quickly',
          'responsibility becomes blurred',
        ],
        proofIntro: 'Horizon provides proof for:',
        proofs: [
      ...
      whoFor: {
        title: 'Who Horizon Is For',
        intro: 'Horizon is designed for roles that **carry responsibility**, not workload:',
        personas: [
          'Legal & Compliance',
          'Risk and AI governance owners',
          'Incident and crisis decision owners',
          'Internal Audit (as verifier and sponsor)',
          'CTO / CIO and accountable executives',
        ],
        conclusion1: 'They are responsible for **defending decisions**',
        conclusion2: '— human or automated.',
      },
      whyNow: {
        title: 'Why Now',
        intro: 'Three forces converge:',
        items: [
          'Accountability-focused regulation',
          'Acceleration of automation and AI',
          'Rising litigation and personal liability',
        ],
        conclusion: 'The cost of missing proof is rising faster than the cost of adoption.',
      },
      productStatus: {
        ...
        conclusion1: 'This is not a dashboard.',
        conclusion2: 'This is **evidence infrastructure**.',
      },
      vision: {
        title: 'The Vision',
  ...
  fr: {
    ...
    horizonPage: {
      hero: {
        title: 'Infrastructure de preuve décisionnelle pour les organisations responsables',
        subtitle: 'Prouver les décisions humaines et automatisées quand la responsabilité est en jeu.',
        hook: 'Quand une décision est remise en question des mois ou des années plus tard, les explications ne suffisent pas.',
        emphasis: 'La **preuve** doit déjà exister.',
      },
      reality: {
        title: 'La réalité des organisations',
        intro: 'Toute organisation prend des décisions porteuses de risques.',
        lines: [
          'Certaines sont automatisées.',
          'Certaines impliquent l\'IA.',
          'Beaucoup sont **purement humaines**.',
        ],
        examplesIntro: 'Par exemple :',
        examples: [
          'incidents de production et décisions de dégradation de service',
          'contournements d\'urgence et actions de crise',
          'acceptation de risques opérationnels, financiers ou cliniques',
          'validations go / no-go pour les déploiements',
          'autorisations de systèmes d\'IA et automatisés',
        ],
        questionsIntro: 'Quand ces décisions sont contestées, les organisations peinent à répondre :',
        questions: [
          'Qu\'a-t-on réellement décidé ?',
          'Qui a pris la décision, un humain ou un système ?',
          'Sous quelle autorité et dans quel contexte ?',
          'Peut-on le prouver de manière indépendante ?',
        ],
        conclusion1: 'Les décisions existent.',
        conclusion2: 'La **preuve**, souvent, non.',
      },
      whyNotAcceptable: {
        title: 'Pourquoi ce n\'est plus acceptable',
        intro: 'Les régulateurs, tribunaux, auditeurs, assureurs et conseils d\'administration demandent désormais :',
        quote: 'Montrez-nous la décision, exactement telle qu\'elle a été déclarée, au moment où elle a été prise.',
        appliesIntro: 'Cela s\'applique à :',
        applies: [
          'la gestion de crise et d\'incidents',
          'les systèmes d\'IA et automatisés',
          'les opérations régulées et à haut risque',
        ],
        conclusion1: 'Ce qui compte n\'est plus l\'explication.',
        conclusion2: 'Ce qui compte, c\'est la **preuve**.',
      },
      insight: {
        title: 'Le constat',
        main: 'Une décision est un **fait de premier ordre**.',
        hook: 'Si elle n\'est pas capturée au moment où elle est déclarée, elle ne peut plus être prouvée de manière fiable.',
        proofIntro: 'La preuve doit être :',
        proofItems: [
          { term: 'native', description: 'capturée au moment de la décision' },
          { term: 'immuable', description: 'scellée cryptographiquement' },
          { term: 'indépendante', description: 'des systèmes impliqués' },
        ],
      },
      solution: {
        title: 'La solution',
        subtitle: 'Un système de référence pour les décisions',
        main: '**Horizon** est une infrastructure de preuve décisionnelle.',
        description: 'Il capture les décisions sous forme de faits immuables et cryptographiquement scellés, qu\'elles soient prises par :',
        sources: [
          'un humain',
          'un système automatisé',
          'ou un agent IA',
        ],
        conclusion1: 'Horizon ne gouverne pas les décisions.',
        conclusion2: 'Il gouverne la **preuve des décisions**.',
      },
      whatDoes: {
        title: 'Ce que fait Horizon',
        ...
        items: [
          ...
          'la sceller dans une chaîne de preuve immuable',
          'la vérifier et l\'exporter de manière indépendante à tout moment',
        ],
      ...
      whatDoesNot: {
        ...
        intro: 'Horizon ne fait **pas** :',
        items: [
          'juger la qualité des décisions',
          'valider la conformité',
          'imposer des politiques ou des workflows',
          'recommander ou biaiser les résultats',
          'remplacer les outils ITSM, BPM ou de gouvernance',
        ],
        conclusion: 'La **neutralité** est ce qui rend la preuve opposable.',
      },
      howItWorks: {
        title: 'Comment fonctionne Horizon',
        steps: [
          { step: 'Une décision est déclarée', detail: 'réponse à incident, approbation, contournement, autorisation' },
          { step: 'Horizon la capture', detail: 'via API, interface, ou intégration' },
          { step: 'La décision est scellée', detail: 'et ajoutée à une chaîne de preuve immuable' },
          { step: 'Un artefact de preuve est généré', detail: 'vérifiable et exportable de manière indépendante' },
        ],
        conclusions: [
          'Pas de reconstruction.',
          'Pas de justification rétrospective.',
          'Pas d\'interprétation.',
        ],
      },
      proofNotLogging: {
        title: 'La preuve n\'est pas du logging',
        intro1: 'Les logs et tickets enregistrent l\'activité.',
        intro2: 'Horizon enregistre la **responsabilité**.',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Traces opérationnelles', horizon: 'Système de référence indépendant' },
          { logs: 'Mutables', horizon: 'Ajout seul, signés' },
          { logs: 'Contexte reconstruit après coup', horizon: 'Contexte scellé au moment de la décision' },
          { logs: 'Non autonomes juridiquement', horizon: 'Preuve juridiquement opposable' },
        ],
        conclusion: 'Horizon introduit une **séparation des pouvoirs** entre la prise de décision et la preuve de décision.',
      },
      modules: {
        title: 'Une plateforme de preuve. Plusieurs domaines démontrés',
        intro: 'Horizon est une **infrastructure de preuve unique**.',
        subtitle: 'Les modules domaines sont des **couches de capture légères** sur la même chaîne de preuve.',
        items: [
          { name: 'AI Governance', description: 'Preuve des décisions humaines concernant les systèmes d\'IA et automatisés.' },
          { name: 'ForenAI', description: 'Preuve forensique des actions d\'agents IA et des traces d\'exécution.' },
          { name: 'Decision Gateway', description: 'Capture de décision machine-vers-humain quand l\'automatisation doit s\'interrompre.' },
          { name: 'Health', description: 'Décisions cliniques et faits post-décision, avec minimisation stricte des données.' },
        ],
        conclusion1: 'Les modules ne sont pas des produits.',
        conclusion2: 'Ce sont des vues structurées sur la même couche de preuve.',
      },
      beachhead: {
        title: 'Tête de pont : Responsabilité de l\'IA',
        intro: 'Les systèmes d\'IA amplifient le problème de la preuve :',
        risks: [
          'les décisions passent à l\'échelle instantanément',
          'le contexte s\'efface rapidement',
          'la responsabilité devient floue',
        ],
        proofIntro: 'Horizon fournit la preuve pour :',
        proofs: [
          'les validations de mise en production IA',
          'l\'acceptation des risques résiduels liés à l\'IA',
          'les décisions de supervision humaine',
          'les contournements et actions d\'urgence',
          'les décisions post-incident',
        ],
        conclusion: 'C\'est la **couche de preuve ex-post** manquante requise par le EU AI Act (Articles 12, 14, 26).',
      },
      whoFor: {
        title: 'À qui s\'adresse Horizon',
        intro: 'Horizon est conçu pour les rôles qui **portent la responsabilité**, pas la charge de travail :',
        personas: [
          'Juridique & Conformité',
          'Responsables risques et gouvernance IA',
          'Responsables décisions d\'incident et de crise',
          'Audit interne (vérificateur et sponsor)',
          'CTO / CIO et dirigeants responsables',
        ],
        conclusion1: 'Ils sont responsables de **défendre les décisions**',
        conclusion2: '— humaines ou automatisées.',
      },
      whyNow: {
        title: 'Pourquoi maintenant',
        intro: 'Trois forces convergent :',
        items: [
          'Une réglementation centrée sur la responsabilité',
          'L\'accélération de l\'automatisation et de l\'IA',
          'La montée des litiges et de la responsabilité personnelle',
        ],
        conclusion: 'Le coût de la preuve manquante augmente plus vite que le coût d\'adoption.',
      },
      productStatus: {
        ...
        items: [
          ...
          'scellement de décisions en ajout seul',
          'artefacts de preuve vérifiables indépendamment',
          'architecture API-first, multi-tenant',
          'plusieurs domaines de décision déjà démontrés',
        ],
        conclusion1: 'Ce n\'est pas un tableau de bord.',
        conclusion2: 'C\'est une **infrastructure de preuve**.',
      },
      vision: {
        title: 'La vision',
        line1: 'Là où les systèmes comptables enregistrent l\'argent,',
        line2: '**Horizon enregistre la responsabilité.**',
        conclusion: 'Toute organisation responsable aura besoin d\'un système de référence pour ses décisions.',
      },
      cta: {
