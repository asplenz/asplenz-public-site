...
export const content = {
  en: {
    ...
    hero: {
      ...
      descriptionParts: [
        { text: 'When an automated ', bold: false },
        { text: 'credit decision', bold: true },
        { text: ' is challenged, can you produce the exact factual state of the execution: immediately, without reconstruction, and with mathematical certainty?', bold: false },
      ],
      highlight: '',
      subtext: '',
      cta1: 'Request a CRO-Level Technical Briefing',
    ...
    contact: {
      ...
      intro: 'Horizon is designed for regulated institutions evaluating decision evidence infrastructure. We welcome inquiries from risk, compliance, and technical leaders.',
...
**It ensures that, when examination is required, facts already exist.**`,
  ...
  fr: {
    ...
    hero: {
      ...
      descriptionParts: [
        { text: 'Lorsqu\'une ', bold: false },
        { text: 'décision de crédit', bold: true },
        { text: ' automatisée est contestée, pouvez-vous produire l\'état factuel exact de l\'exécution : immédiatement, sans reconstruction et avec une certitude mathématique ?', bold: false },
      ],
      highlight: '',
      subtext: '',
      cta1: 'Demander un briefing technique - Niveau CRO',
    ...
    contact: {
      ...
      intro: 'Horizon est conçu pour les institutions régulées évaluant une infrastructure de preuve décisionnelle. Nous accueillons les demandes des responsables risque, conformité et technique.',
