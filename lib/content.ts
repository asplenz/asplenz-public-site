  ...
  en: {
    ...
    index: {
      hero: {
        ...
        headlineItalic: 'Trace how they followed them.',
      ...
      heroCard: {
        ...
        steps: [
          { icon: '📋', label: 'knowledge_list_invariants', text: 'scope: "finance" / ns: "risk"', badge: 'Max 5% per issuer', badgeColor: 'blue' },
          { icon: '📐', label: 'knowledge_list_rules', text: 'scope: "finance" / ns: "pricing"', badge: 'EUR mid-swap benchmark - MANDATORY', badgeColor: 'blue' },
          { icon: '🔍', label: 'Exposure check', text: 'Current: 4.2% + requested +2% | Result: 6.2% > limit 5%', badge: '', badgeColor: 'orange' },
          { icon: '⚠️', label: 'Agent decision', text: 'Purchase not recommended', badge: 'finance/risk invariant consulted', badgeColor: 'amber' },
          { icon: '✓', label: 'knowledge_record', text: 'Choice documented', badge: 'dec-d2c9e8e8fa1b', badgeColor: 'green' },
        ],
      },
      problem: {
        tag: 'The problem',
        ...
        cells: [
          { q: 'How do my agents know our pricing conventions?', a: "They're in a system prompt written 6 months ago, potentially obsolete and unversioned." },
          { q: 'How do I know if an agent followed our risk limits?', a: "You can't prove it. Logs exist, but the decision isn't linked to the rule." },
          { q: 'If a rule changes, how do I update all my agents?', a: 'You edit each prompt manually — hoping you miss none.' },
          { q: 'My auditor asks for proof of AI agent compliance.', a: 'You have no audit trail linking agent decisions to the rules in force at the time.' },
        ],
      },
      howItWorks: {
        tag: 'How it works',
        ...
        concepts: {
          cards: [
            { n: 1, badge: 'Invariants', badgeColor: 'red', title: 'Absolute constraints', desc: 'Non-negotiable rules your agents must consult before acting. They define the limits your organization never wants to cross.', example: 'e.g. "Maximum exposure of 5% per issuer."' },
            { n: 2, badge: 'Rules', badgeColor: 'blue', title: 'Active directives', desc: 'Mandatory or advisory operational conventions. Versioned, dated, with identified author. Updated in one place, propagated to all agents.', example: 'e.g. "Use EUR mid-swap curve for bond pricing."' },
            { n: 3, badge: 'Decisions', badgeColor: 'green', title: 'Documented choices', desc: 'Immutable records of significant choices - with request context, applied reasoning, and conclusion. Queryable via knowledge_query.', example: 'e.g. "TotalEnergies +2% purchase not recommended - concentration invariant consulted."' },
            { n: 4, badge: 'Overrides', badgeColor: 'orange', title: 'Formal exceptions', desc: 'A documented exception from a rule or invariant — with named approver, justification, and automatic expiry. Not a workaround: a traced exception.', example: 'e.g. "1h temporary exception — 6.2% purchase approved by CIO."' },
          ],
        },
        scopes: {
          tag: 'Scopes & Namespaces',
          title: 'Organize your rules at your organization\'s granularity',
          desc: 'Each scope subdivides into namespaces - to organize your rules by business domain and refine permissions per team or agent. A pricing agent only loads the pricing namespace rules, not the entire finance scope.',
          benefits: [
        ...
        flow: {
          nodes: [
            { icon: '👤', label: 'Your organization', sub: 'Rules & invariants' },
            { icon: '⚡', label: 'Knowledge', sub: 'Central registry' },
            { icon: '🤖', label: 'Agents & copilots', sub: 'Claude, GPT, Code...' },
            { icon: '📊', label: 'Audit log', sub: 'Decisions & references' },
            { icon: '🔍', label: 'Auditors & teams', sub: 'Compliance' },
          ],
          arrows: ['exposes', 'queries', 'traces', 'reviews'],
        },
      },
      useCases: {
        tag: 'Use cases',
        ...
        items: [
          { type: 'Autonomous agent', icon: '🏦', title: 'Finance & Trading', desc: 'Exposure limits, pricing benchmarks, regulatory compliance rules. Every choice documented and linked to the rule that motivated it.' },
          { type: 'Autonomous agent', icon: '💻', title: 'Coding agents', desc: 'Claude Code, Cursor, and your CI/CD pipelines share the same architecture and security registry. Past technical decisions, queryable by all.' },
          { type: 'Autonomous agent', icon: '⚙️', title: 'CI/CD pipelines', desc: 'Every deployment consults security rules before acting. No secrets in plaintext, no unvalidated deployment - traced at every run.' },
          { type: 'Autonomous agent', icon: '💬', title: 'Conversational LLMs', desc: 'Your Claude Teams or Enterprise assistants automatically apply your organization\'s communication, confidentiality, and compliance rules.' },
          { type: 'Copilot - human assistance', icon: '🏥', title: 'Healthcare & Pharma', desc: 'Dosages, contraindications, clinical protocols. The copilot informs the physician of applicable rules. Final decision stays human, Knowledge traces what was consulted.' },
          { type: 'Copilot - human assistance', icon: '⚖️', title: 'Legal & Contractual', desc: 'Mandatory clauses, liability caps, required approval levels. The copilot alerts the lawyer, who validates. Knowledge traces what was consulted.' },
        ],
      },
      comparison: {
        tag: 'Differentiation',
        title: 'Beyond the system prompt',
        sub: 'A system prompt configures one agent. Knowledge governs all your agents - with traceability, versioning, and accountability.',
        col1: 'System Prompt',
        col2: 'Knowledge',
        rows: [
          { criterion: 'Updates', before: 'Manual, per instance', after: 'One rule changed, all agents updated' },
          { criterion: 'Traceability', before: 'None', after: 'Every consultation recorded and auditable' },
          { criterion: 'Contextual memory', before: 'Can be forgotten in long context', after: 'Always queryable via API' },
          { criterion: 'Exceptions', before: 'No formal mechanism', after: 'Override documented, approved, expirable' },
          { criterion: 'Sharing', before: 'Single instance', after: 'All agents, all users, all LLMs' },
          { criterion: 'Granularity', before: 'Monolithic', after: 'Scopes & namespaces - deterministic resolution' },
          { criterion: 'Compliance proof', before: 'Declared intent', after: 'Traced and auditable execution' },
          { criterion: 'Dependencies', before: 'No visibility', after: 'Graph of links between rules, decisions, overrides' },
        ],
      },
      aiAct: {
        tag: 'Compliance',
        ...
        cards: [
          { article: 'Article 14', title: 'Human Oversight', desc: 'The formal override mechanism is a direct implementation of the human supervision required by the regulation.' },
          { article: 'Article 13', title: 'Transparency', desc: 'Versioned rules and invariants. A regulator can consult the exact state of the registry at any point in time.' },
          { article: 'Article 15', title: 'Robustness', desc: 'Unlike a prompt subject to contextual forgetting, every consultation is traced via API — a native audit trail for every action.' },
        ],
      },
      integrations: {
        tag: 'Integrations',
        ...
        tiers: [
          {
            name: 'Starter',
            price: 'Free',
            desc: 'For developers and teams exploring Knowledge.',
            features: ['1 scope / 3 namespaces', '3 users / 10 agents', '10,000 calls / month', '30-day history', 'REST API & MCP'],
          ...
          },
          {
            name: 'Team',
            price: '€299/month',
            desc: 'For teams deploying agents in production.',
            features: ['Unlimited scopes & namespaces', '500,000 calls / month', 'Unlimited history', 'Overrides & approvals', 'Dependency graph'],
          ...
          },
          {
            name: 'Enterprise',
            price: 'Custom',
            desc: 'For large organizations with advanced compliance requirements.',
            features: ['Everything in Team', 'SSO & SCIM', 'On-premise deployment', 'Guaranteed SLA', 'Dedicated AI Act support', 'Third-party audit'],
            cta: 'Contact us',
            ctaHref: '/contact',
            featured: false,
          },
      ...
      ctaFinal: {
        tag: 'Ready to start?',
        title: 'Your rules deserve better than a prompt.',
        body: 'Join the teams exposing their rules to their agents and tracing how they followed them.',
  ...
  fr: {
    ...
    index: {
      hero: {
        ...
        headlineItalic: 'Tracez comment ils les ont suivies.',
      ...
      heroCard: {
        title: 'Agent - Finance / Risk',
        steps: [
          { icon: '📋', label: 'knowledge_list_invariants', text: 'scope: "finance" / ns: "risk"', badge: 'Max 5% par émetteur', badgeColor: 'blue' },
          { icon: '📐', label: 'knowledge_list_rules', text: 'scope: "finance" / ns: "pricing"', badge: 'Benchmark EUR mid-swap - OBLIGATOIRE', badgeColor: 'blue' },
          { icon: '🔍', label: 'Vérification exposition', text: 'Actuelle : 4,2% + demandé +2% | Résultante : 6,2% > limite 5%', badge: '', badgeColor: 'orange' },
          { icon: '⚠️', label: 'Décision agent', text: 'Achat non recommandé', badge: 'Invariant finance/risk consulté', badgeColor: 'amber' },
          { icon: '✓', label: 'knowledge_record', text: 'Choix documenté', badge: 'dec-d2c9e8e8fa1b', badgeColor: 'green' },
        ],
      },
      problem: {
        tag: 'Le problème',
        ...
        cells: [
          { q: 'Comment mes agents connaissent-ils nos conventions de pricing ?', a: 'Elles sont dans un prompt rédigé il y a 6 mois, potentiellement obsolète et non versionné.' },
          { q: 'Comment savoir si un agent a tenu compte de nos limites de risque ?', a: 'Vous ne pouvez pas le prouver. Les logs existent, mais la décision n\'est pas liée à la règle.' },
          { q: 'Si une règle change, comment mettre à jour tous mes agents ?', a: 'Vous modifiez chaque prompt manuellement — en espérant n\'en oublier aucun.' },
          { q: 'Mon auditeur demande la preuve de conformité de nos agents IA.', a: 'Vous n\'avez aucune piste d\'audit liant les décisions des agents aux règles en vigueur au moment des faits.' },
        ],
      },
      howItWorks: {
        tag: 'Comment ça marche',
        title: 'Un registre. Quatre types d\'entrées.',
        ...
        concepts: {
          cards: [
            { n: 1, badge: 'Invariants', badgeColor: 'red', title: 'Contraintes absolues', desc: 'Des règles non négociables que vos agents doivent consulter avant d\'agir. Elles définissent les limites que votre organisation ne souhaite jamais franchir.', example: 'Ex : "Exposition maximale de 5% par émetteur."' },
            { n: 2, badge: 'Règles', badgeColor: 'blue', title: 'Directives actives', desc: 'Des conventions opérationnelles mandatory ou advisory. Versionnées, datées, avec auteur identifié. Mises à jour en un point, propagées à tous les agents.', example: 'Ex : "Utiliser la courbe EUR mid-swap pour le pricing obligataire."' },
            { n: 3, badge: 'Décisions', badgeColor: 'green', title: 'Choix documentés', desc: 'Des enregistrements immutables de choix significatifs - avec contexte de la demande, raisonnement appliqué, et conclusion. Consultables via knowledge_query.', example: 'Ex : "Achat TotalEnergies +2% non recommandé - invariant de concentration consulté."' },
            { n: 4, badge: 'Dérogations (Overrides)', badgeColor: 'orange', title: 'Exceptions formelles', desc: 'Une exception documentée à une règle ou un invariant — avec approbateur nommé, justification et expiration automatique. Pas un contournement : une exception tracée.', example: 'Ex : "Dérogation temporaire 1h — achat à 6,2% approuvé par le CIO."' },
          ],
        },
        scopes: {
          tag: 'Scopes & Namespaces',
        ...
        flow: {
          nodes: [
            { icon: '👤', label: 'Votre organisation', sub: 'Règles & invariants' },
            { icon: '⚡', label: 'Knowledge', sub: 'Registre central' },
            { icon: '🤖', label: 'Agents & copilotes', sub: 'Claude, GPT, Code...' },
            { icon: '📊', label: 'Journal d\'audit', sub: 'Décisions & références' },
            { icon: '🔍', label: 'Auditeurs & équipes', sub: 'Conformité' },
          ],
          arrows: ['expose', 'consulte', 'trace', 'consulte'],
        },
      },
      useCases: {
        tag: 'Cas d\'usage',
        ...
        items: [
          { type: 'Agent autonome', icon: '🏦', title: 'Finance & Trading', desc: 'Limites d\'exposition, benchmarks de pricing, règles de conformité réglementaire. Chaque choix documenté et lié à la règle qui l\'a motivé.' },
          { type: 'Agent autonome', icon: '💻', title: 'Agents de coding', desc: 'Claude Code, Cursor et vos pipelines CI/CD partagent le même registre d\'architecture et de sécurité. Les décisions techniques passées, consultables par tous.' },
          { type: 'Agent autonome', icon: '⚙️', title: 'Pipelines CI/CD', desc: 'Chaque déploiement consulte les règles de sécurité avant d\'agir. Aucun secret en clair, aucun déploiement non validé - tracé à chaque run.' },
          { type: 'Agent autonome', icon: '💬', title: 'LLM conversationnels', desc: 'Vos assistants Claude Teams ou Enterprise appliquent automatiquement les règles de communication, de confidentialité et de conformité de votre organisation.' },
          { type: 'Copilote - assistance humaine', icon: '🏥', title: 'Santé & Pharma', desc: 'Dosages, contre-indications, protocoles cliniques. Le copilote informe le médecin des règles en vigueur. La décision finale reste humaine, Knowledge trace ce qui a été consulté.' },
          { type: 'Copilote - assistance humaine', icon: '⚖️', title: 'Juridique & Contractuel', desc: 'Clauses obligatoires, plafonds de responsabilité, niveaux d\'approbation requis. Le copilote alerte le juriste, qui valide. Knowledge trace ce qui a été consulté.' },
        ],
      },
      comparison: {
        tag: 'Différenciation',
        title: 'Au-delà du system prompt',
        sub: 'Un system prompt configure un agent. Knowledge gouverne tous vos agents - avec traçabilité, versioning et responsabilisation.',
        col1: 'System Prompt',
        col2: 'Knowledge',
        rows: [
          { criterion: 'Mise à jour', before: 'Manuelle, par instance', after: 'Une règle modifiée, tous les agents mis à jour' },
          { criterion: 'Traçabilité', before: 'Aucune', after: 'Chaque consultation enregistrée et auditable' },
          { criterion: 'Mémoire contextuelle', before: 'Peut être oublié en long contexte', after: 'Toujours consultable via API' },
          { criterion: 'Exceptions', before: 'Pas de mécanisme formel', after: 'Override documenté, approuvé, expirable' },
          { criterion: 'Partage', before: 'Une seule instance', after: 'Tous agents, tous utilisateurs, tous LLM' },
          { criterion: 'Granularité', before: 'Monolithique', after: 'Scopes & namespaces - résolution déterministe' },
          { criterion: 'Preuve de conformité', before: 'Intention déclarée', after: 'Exécution tracée et auditable' },
          { criterion: 'Dépendances', before: 'Aucune visibilité', after: 'Graphe de liens entre règles, décisions, overrides' },
        ],
      },
      aiAct: {
        tag: 'Conformité',
        ...
        cards: [
          { article: 'Article 14', title: 'Supervision humaine', desc: 'Le mécanisme de dérogation formelle est une implémentation directe de la supervision humaine requise par le règlement.' },
          { article: 'Article 13', title: 'Transparence', desc: 'Invariants et règles versionnés. Un régulateur peut consulter l\'état exact du registre à n\'importe quel point dans le temps.' },
          { article: 'Article 15', title: 'Robustesse', desc: 'Contrairement à un prompt sujet à l\'oubli contextuel, chaque consultation est tracée via API — une piste d\'audit intrinsèque à chaque action.' },
        ],
      },
      integrations: {
        tag: 'Intégrations',
      ...
      pricing: {
        ...
        sub: 'Un tier gratuit pour explorer, des plans entreprise pour déployer à l\'échelle.',
        tiers: [
          {
            name: 'Starter',
            price: 'Gratuit',
            desc: 'Pour les développeurs et équipes qui explorent Knowledge.',
            features: ['1 scope / 3 namespaces', '3 utilisateurs / 10 agents', '10 000 appels / mois', 'Historique 30 jours', 'API REST & MCP'],
          ...
          },
          {
            name: 'Team',
            price: '299 €/mois',
            desc: 'Pour les équipes qui déploient des agents en production.',
            features: ['Scopes & namespaces illimités', '500 000 appels / mois', 'Historique illimité', 'Dérogations & approbations', 'Graphe de dépendances'],
          ...
          },
          {
            name: 'Enterprise',
            price: 'Sur devis',
            desc: 'Pour les grandes organisations avec des exigences de conformité avancées.',
            features: ['Tout le plan Team', 'SSO & SCIM', 'Déploiement on-premise', 'SLA garanti', 'Support AI Act dédié', 'Audit tiers'],
            cta: 'Nous contacter',
            ctaHref: '/contact',
            featured: false,
          },
        ...
        verifierAddon: {
          ...
          note: 'Le Verifier est inclus dans tous les forfaits.',
        },
      },
      ctaFinal: {
        tag: 'Prêt à commencer ?',
        title: 'Vos règles méritent mieux qu\'un prompt.',
        body: 'Rejoignez les équipes qui exposent leurs règles à leurs agents et tracent comment ils les ont suivies.',
