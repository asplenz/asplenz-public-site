...
send_decision_to_applicant(decision_result)`,
    ...
    hub: {
      ...
      perspectives: [
        {
          letter: 'A',
          title: 'The Business & Strategic Perspective',
          audience: 'For COOs, CFOs, and Transformation Leads.',
          description: 'Focus on why current "post-hoc" investigation methods are a silent drain on productivity and how automating evidence production impacts the bottom line.',
          linkText: 'Go to Landing Page: Value & ROI',
          href: '/',
        },
        {
          letter: 'B',
...
notifier_decision_client(resultat_decision)`,
    ...
    hub: {
      ...
      perspectives: [
        {
          letter: 'A',
          title: 'Perspective Business & Stratégique',
          audience: 'Pour les Directions Opérationnelles (COO), Financières (CFO) et de la Transformation.',
          description: 'Découvrez pourquoi les méthodes actuelles d\'investigation « a posteriori » pèsent silencieusement sur la productivité et comment l\'automatisation de la production de preuves impacte directement vos résultats financiers.',
          linkText: 'Aller à la Landing Page : Valeur & ROI',
          href: '/',
        },
        {
          letter: 'B',
