...
export const content = {
  en: {
    ...
    index: {
      ...
      howItWorks: {
        ...
        steps: ['Declare', 'Capture', 'Seal', 'Verify'],
        description: 'Decisions are explicitly declared, cryptographically sealed, and independently verifiable. Without changing how teams work.',
        link: 'Learn how the proof layer works',
      },
      proofNotLogging: {
        title: 'Proof Is Not Logging',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Operational traces', horizon: 'Independent proof' },
          { logs: 'Mutable', horizon: 'Append-only, signed' },
          { logs: 'Context rebuilt later', horizon: 'Context sealed at decision time' },
          { logs: 'Not defensible alone', horizon: 'Legally defensible' },
        ],
        conclusion: 'Horizon introduces a **separation of powers** between deciding and proving.',
      },
      whyNow: {
        title: 'Why now',
        items: [
          'Regulators now require proof, not explanations (EU AI Act)',
          'Automation and AI blur responsibility',
          'Courts and auditors demand facts, not narratives',
        ],
      },
      simpleQuestion: {
    ...
    // Horizon deep-dive page
    horizonPage: {
      hero: {
        title: 'Decision Proof Infrastructure for Accountable Organizations',
        subtitle: 'Proving human and automated decisions when accountability matters.',
        hook: 'When a decision is questioned months or years later, explanations are not enough.',
        emphasis: '**Proof must already exist.**',
      },
      governance: {
        title: 'Governance Defines Responsibility. Horizon Proves It.',
        p1: 'Governance frameworks define policies, roles, oversight structures, and accountability models.',
        p2: 'Horizon does not design governance.',
        p3: 'Horizon records the **moment responsibility is assumed**.',
        p4a: 'Where governance defines *who should decide*,',
        p4b: 'Horizon proves *what was decided, by whom, and when*.',
      },
      reality: {
        title: 'Decisions Happen. Proof Doesn\'t Scale.',
        p1: 'Every organization makes decisions that carry risk: production incidents, emergency overrides, risk acceptances, deployment approvals, AI authorizations.',
        p2: 'Some are automated. Some involve AI. Many are purely human.',
        p3: 'The evidence scatters: an email here, a Slack message there, a verbal "yes" in a meeting, a Jira ticket never updated.',
        p4: 'Multiply that across 50 systems, 20 decision-makers, 12 months.',
        p5: 'When a regulator, a court, an auditor, or a board demands an answer:',
        quote: 'Who authorized this? When? Under which authority? Can this be proven independently?',
        p6: 'Reconstruction does not scale.',
        p7: 'Accountability does not tolerate reconstruction.',
        conclusion: '**A decision without proof, when challenged, cannot be defended.**',
      },
      solution: {
        title: 'The Solution',
        main: '**Horizon is a decision proof infrastructure.**',
        p1: 'It captures decisions as immutable, cryptographically sealed facts, whether they are made by a human, an automated system, or an AI agent.',
        p2: 'Horizon does not govern decisions.',
        p3: 'It governs the **evidence of decisions**.',
        intro: 'Horizon allows organizations to:',
        items: [
        ...
        conclusion: 'Once sealed, a decision cannot be altered, rewritten, or retroactively reconstructed.',
      },
      howItWorks: {
        title: 'How Horizon Works',
        steps: [
          { step: 'A decision is declared', detail: 'approval, override, authorization, risk acceptance' },
          { step: 'Horizon captures it', detail: 'via API, UI, or integration' },
          { step: 'The decision is cryptographically sealed', detail: 'SHA-256 hash chain, Ed25519 signatures' },
          { step: 'It is appended to an immutable proof chain', detail: '' },
          { step: 'A proof artifact is generated', detail: 'and remains independently verifiable' },
        ],
        conclusion: 'No reconstruction. No retroactive justification. No interpretation.',
      },
      layers: {
        title: 'Separation of Layers',
        rows: [
          { label: 'Board & Governance Design', target: 'Advisory / Frameworks' },
          { label: 'Policies & Risk Models', target: 'GRC / Internal Controls' },
          { label: 'Declared Decision Event', target: 'Horizon' },
          { label: 'Operational Execution', target: 'Client Systems' },
        ],
        p1: 'Horizon sits at the **decision moment**.',
        p2: 'It is the infrastructure that transforms a declared decision into a durable, independent artifact of proof.',
      },
      proofNotLogging: {
        title: 'Proof Is Not Logging',
        intro: 'Logs record activity. Horizon records responsibility.',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Operational traces', horizon: 'Independent system of record' },
          { logs: 'Mutable / rotatable', horizon: 'Append-only, cryptographically signed' },
          { logs: 'Context rebuilt later', horizon: 'Context sealed at declaration time' },
          { logs: 'Owned by source systems', horizon: 'Independent evidence layer' },
          { logs: 'For troubleshooting', horizon: 'For accountability' },
        ],
        conclusion: 'Horizon introduces a **separation of powers** between decision-making and decision proof.',
      },
      whatIsNot: {
        title: 'What Horizon Is Not',
        p1: 'Horizon is not a governance framework, a compliance methodology, a risk assessment model, a control system, a workflow engine, or a policy enforcement tool.',
        p2: 'Horizon does not judge decision quality, validate regulatory compliance, interpret or score outcomes, recommend actions, or bias decisions.',
        p3: 'Horizon does not replace governance.',
        p4: 'It makes governance provable.',
        p5: 'It records facts.',
        conclusion: '**Neutrality is what makes the evidence defensible.**',
      },
      modules: {
        title: 'One Proof Platform. Multiple Domains.',
        intro: 'Horizon is a single evidence infrastructure. Modules are structured capture layers over the same proof chain.',
        items: [
          { name: 'AI Governance', description: 'Proof of human decisions about AI systems.' },
          { name: 'ForenAI', description: 'Forensic proof of AI agent execution chains.' },
          { name: 'Decision Gateway', description: 'Structured capture of human decisions triggered by automation.' },
          { name: 'Health', description: 'Clinical decisions and post-decision facts with strict data minimization.' },
        ],
        conclusion: 'Modules do not change the infrastructure. They structure how decisions enter the same immutable record.',
      },
      beachhead: {
        title: 'Beachhead: AI Accountability',
        intro: 'AI systems amplify the proof problem: decisions scale instantly, context disappears quickly, responsibility becomes blurred.',
        proofIntro: 'Horizon provides evidence for:',
        proofs: [
        ...
        conclusion: 'This is the missing **ex-post proof layer** required by the EU AI Act (Articles 12, 14, 26).',
      },
      whoFor: {
        title: 'Who Horizon Is For',
        intro: 'Horizon is designed for roles that **carry responsibility**:',
        personas: [
          'Legal & Compliance',
        ...
        conclusion1: 'They are responsible for defending decisions.',
        conclusion2: 'Horizon provides the artifact that allows them to do so.',
      },
      whyNow: {
        title: 'Why Now',
        intro: 'Three structural forces converge:',
        items: [
          '**Accountability-focused regulation** (EU AI Act, DORA, NIST AI RMF)',
          '**Acceleration of automation and AI** across every regulated sector',
          '**Rising litigation and executive liability**',
        ],
        p1: 'Governance is no longer advisory. It is liability architecture.',
        conclusion: 'Horizon is the infrastructure that makes that architecture defensible.',
      },
      productStatus: {
        title: 'Product Status',
        intro: 'Horizon is live and demonstrable.',
        items: [
        ...
        conclusion: 'This is not a dashboard. This is **evidence infrastructure**.',
      },
      vision: {
        title: 'The Vision',
        line1: 'Where accounting systems record money,',
        line2: '**Horizon records responsibility.**',
        conclusion: 'Every accountable organization will need a system of record for decisions.',
      },
      cta: {
        intro: 'If decisions in your organization can be questioned later, during an incident, an audit, an underwriting review, or litigation, Horizon is the proof layer you are missing.',
        action: 'Discuss Your Decision Architecture',
      },
    },
  ...
  fr: {
    ...
    index: {
      ...
      howItWorks: {
        title: 'Comment fonctionne Horizon',
        steps: ['Déclarer', 'Capturer', 'Sceller', 'Vérifier'],
        description: 'Les décisions sont explicitement déclarées, scellées cryptographiquement et vérifiables de manière indépendante. Sans changer la façon dont les équipes travaillent.',
        link: 'Découvrir le fonctionnement de la couche de preuve',
      },
      proofNotLogging: {
        title: 'La preuve n\'est pas du logging',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Traces opérationnelles', horizon: 'Preuve indépendante' },
          { logs: 'Modifiables', horizon: 'Append-only, signées' },
          { logs: 'Contexte reconstitué après coup', horizon: 'Contexte scellé au moment de la décision' },
          { logs: 'Non opposables seules', horizon: 'Juridiquement opposables' },
        ],
        conclusion: 'Horizon introduit une **séparation des pouvoirs** entre décider et prouver.',
      },
      whyNow: {
        title: 'Pourquoi maintenant',
        items: [
          'Les régulateurs exigent désormais des preuves, pas des explications (EU AI Act)',
          'L\'automatisation et l\'IA brouillent les responsabilités',
          'Les tribunaux et auditeurs exigent des faits, pas des récits',
        ],
      },
      simpleQuestion: {
    ...
    horizonPage: {
      hero: {
        title: 'Infrastructure de Preuve de Décision pour les Organisations Responsables',
        subtitle: 'Prouver les décisions humaines et automatisées lorsque la responsabilité est en jeu.',
        hook: 'Lorsqu\'une décision est remise en question des mois ou des années plus tard, les explications ne suffisent pas.',
        emphasis: '**La preuve doit déjà exister.**',
      },
      governance: {
        title: 'La Gouvernance définit la Responsabilité. Horizon la prouve.',
        p1: 'Les cadres de gouvernance définissent les politiques, les rôles, les structures de surveillance et les modèles de responsabilité.',
        p2: 'Horizon ne conçoit pas la gouvernance.',
        p3: 'Horizon enregistre le **moment où la responsabilité est assumée**.',
        p4a: 'Là où la gouvernance définit *qui doit décider*,',
        p4b: 'Horizon prouve *ce qui a été décidé, par qui, et quand*.',
      },
      reality: {
        title: 'Les décisions surviennent. La preuve ne passe pas à l\'échelle.',
        p1: 'Chaque organisation prend des décisions porteuses de risques : incidents de production, dérogations d\'urgence, acceptations de risques, approbations de déploiement, autorisations d\'IA.',
        p2: 'Certaines sont automatisées. D\'autres impliquent l\'IA. Beaucoup sont purement humaines.',
        p3: 'Les preuves s\'éparpillent : un e-mail ici, un message Slack là, un « oui » verbal en réunion, un ticket Jira jamais mis à jour.',
        p4: 'Multipliez cela par 50 systèmes, 20 décideurs, 12 mois.',
        p5: 'Lorsqu\'un régulateur, un tribunal, un auditeur ou un conseil d\'administration exige une réponse :',
        quote: 'Qui a autorisé cela ? Quand ? Sous quelle autorité ? Cela peut-il être prouvé de manière indépendante ?',
        p6: 'La reconstruction ne passe pas à l\'échelle.',
        p7: 'La responsabilité (accountability) ne tolère pas la reconstruction.',
        conclusion: '**Une décision sans preuve, lorsqu\'elle est contestée, ne peut être défendue.**',
      },
      solution: {
        title: 'La Solution',
        main: '**Horizon est une infrastructure de preuve de décision.**',
        p1: 'Il capture les décisions sous forme de faits immuables et scellés par cryptographie, qu\'elles soient prises par un humain, un système automatisé ou un agent d\'IA.',
        p2: 'Horizon ne gouverne pas les décisions.',
        p3: 'Il gouverne la **preuve des décisions**.',
        intro: 'Horizon permet aux organisations de :',
        items: [
        ...
        conclusion: 'Une fois scellée, une décision ne peut être modifiée, réécrite ou reconstruite rétroactivement.',
      },
      howItWorks: {
        title: 'Comment fonctionne Horizon',
        steps: [
          { step: 'Une décision est déclarée', detail: 'approbation, dérogation, autorisation, acceptation de risque' },
          { step: 'Horizon la capture', detail: 'via API, interface utilisateur ou intégration' },
          { step: 'La décision est scellée par cryptographie', detail: 'chaîne de hachage SHA-256, signatures Ed25519' },
          { step: 'Elle est ajoutée à une chaîne de preuve immuable', detail: '' },
          { step: 'Un artefact de preuve est généré', detail: 'et reste vérifiable de manière indépendante' },
        ],
        conclusion: 'Pas de reconstruction. Pas de justification rétroactive. Pas d\'interprétation.',
      },
      layers: {
        title: 'Séparation des Couches',
        rows: [
          { label: 'Conseil & Design de Gouvernance', target: 'Conseil / Cadres de référence' },
          { label: 'Politiques & Modèles de Risque', target: 'GRC / Contrôles Internes' },
          { label: 'Événement de Décision Déclaré', target: 'Horizon' },
          { label: 'Exécution Opérationnelle', target: 'Systèmes Clients' },
        ],
        p1: 'Horizon se situe au **moment de la décision**.',
        p2: 'C\'est l\'infrastructure qui transforme une décision déclarée en un artefact de preuve durable et indépendant.',
      },
      proofNotLogging: {
        title: 'La Preuve n\'est pas la Journalisation (Logging)',
        intro: 'Les logs enregistrent l\'activité. Horizon enregistre la responsabilité.',
        columnLogs: 'Logs & tickets',
        columnHorizon: 'Horizon',
        rows: [
          { logs: 'Traces opérationnelles', horizon: 'Système d\'enregistrement indépendant' },
          { logs: 'Mutables / volatiles', horizon: 'Ajout uniquement, signé par cryptographie' },
          { logs: 'Contexte reconstruit après', horizon: 'Contexte scellé au moment de la déclaration' },
          { logs: 'Détenus par les systèmes', horizon: 'Couche de preuve indépendante' },
          { logs: 'Pour le dépannage', horizon: 'Pour la responsabilité (accountability)' },
        ],
        conclusion: 'Horizon introduit une **séparation des pouvoirs** entre la prise de décision et la preuve de la décision.',
      },
      whatIsNot: {
        title: 'Ce qu\'Horizon n\'est pas',
        p1: 'Horizon n\'est pas un cadre de gouvernance, une méthodologie de conformité, un modèle d\'évaluation des risques, un système de contrôle, un moteur de workflow ou un outil d\'application de politiques.',
        p2: 'Horizon ne juge pas la qualité des décisions, ne valide pas la conformité réglementaire, n\'interprète pas et ne note pas les résultats, ne recommande pas d\'actions et n\'influence pas les décisions.',
        p3: 'Horizon ne remplace pas la gouvernance.',
        p4: 'Il rend la gouvernance prouvable.',
        p5: 'Il enregistre des faits.',
        conclusion: '**C\'est la neutralité qui rend la preuve défendable.**',
      },
      modules: {
        title: 'Une Plateforme de Preuve Unique. Domaines Multiples.',
        intro: 'Horizon est une infrastructure de preuve unique. Les modules sont des couches de capture structurées sur la même chaîne de preuve.',
        items: [
          { name: 'AI Governance', description: 'Preuve des décisions humaines concernant les systèmes d\'IA.' },
          { name: 'ForenAI', description: 'Preuve forensique des chaînes d\'exécution des agents d\'IA.' },
          { name: 'Decision Gateway', description: 'Capture structurée des décisions humaines déclenchées par l\'automatisation.' },
          { name: 'Health', description: 'Décisions cliniques et faits post-décision avec une minimisation stricte des données.' },
        ],
        conclusion: 'Les modules ne changent pas l\'infrastructure. Ils structurent la manière dont les décisions entrent dans le même enregistrement immuable.',
      },
      beachhead: {
        title: 'Tête de pont : La Responsabilité de l\'IA (AI Accountability)',
        intro: 'Les systèmes d\'IA amplifient le problème de la preuve : les décisions passent à l\'échelle instantanément, le contexte disparaît rapidement, la responsabilité devient floue.',
        proofIntro: 'Horizon fournit des preuves pour :',
        proofs: [
        ...
        conclusion: 'Il s\'agit de la **couche de preuve ex-post** manquante requise par l\'IA Act de l\'UE (Articles 12, 14, 26).',
      },
      whoFor: {
        title: 'À qui s\'adresse Horizon',
        intro: 'Horizon est conçu pour les rôles qui **portent la responsabilité** :',
        personas: [
        ...
        conclusion1: 'Ils sont chargés de défendre les décisions.',
        conclusion2: 'Horizon fournit l\'artefact qui leur permet de le faire.',
      },
      whyNow: {
        title: 'Pourquoi Maintenant',
        intro: 'Trois forces structurelles convergent :',
        items: [
          '**Réglementations axées sur la responsabilité** (IA Act de l\'UE, DORA, NIST AI RMF)',
          '**Accélération de l\'automatisation et de l\'IA** dans tous les secteurs réglementés',
          '**Augmentation des litiges et de la responsabilité des dirigeants**',
        ],
        p1: 'La gouvernance n\'est plus consultative. C\'est une architecture de responsabilité civile et pénale.',
        conclusion: 'Horizon est l\'infrastructure qui rend cette architecture défendable.',
      },
      productStatus: {
        title: 'État du Produit',
        intro: 'Horizon est opérationnel et démontrable.',
        items: [
        ...
        conclusion: 'Ceci n\'est pas un tableau de bord. C\'est une **infrastructure de preuve**.',
      },
      vision: {
        title: 'La Vision',
        line1: 'Là où les systèmes comptables enregistrent l\'argent,',
        line2: '**Horizon enregistre la responsabilité.**',
        conclusion: 'Toute organisation responsable aura besoin d\'un système d\'enregistrement pour ses décisions.',
      },
      cta: {
        intro: 'Si les décisions au sein de votre organisation peuvent être remises en question plus tard, lors d\'un incident, d\'un audit, d\'un examen de souscription ou d\'un litige, Horizon est la couche de preuve qui vous manque.',
        action: 'Échanger sur votre architecture décisionnelle',
      },
    },
