...
export const content = {
  en: {
    ...
    index: {
      hero: {
        headline: 'Your AI agents are fast. But they don\'t know your rules.',
        description: 'Architecture decisions, compliance constraints, security invariants - your organization has hundreds of rules that AI agents ignore because no system exists to tell them. Knowledge is the single registry they query before acting.',
  ...
  fr: {
    ...
    index: {
      hero: {
        headline: 'Vos agents IA sont rapides. Mais ils ne connaissent pas vos règles.',
        description: 'Décisions d\'architecture, contraintes de conformité, invariants de sécurité - votre organisation possède des centaines de règles que les agents IA ignorent parce qu\'aucun système n\'existe pour les leur transmettre. Knowledge est le registre unique qu\'ils interrogent avant d\'agir.',
