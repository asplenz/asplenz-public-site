...
export const content = {
  en: {
    ...
    problem: {
      title: 'When facts can no longer be proven post-incident',
      intro: 'During a major security incident:',
      bullets: [
      ...
      questions_intro: 'Weeks later, the questions arrive:',
      questions: [
      ...
      reconstruction: 'At that point, reality is reconstructed from emails, chat logs, partial system traces, and human memory.',
      conclusion: 'That reconstruction is fragile.',
    },
    howHorizonWorks: {
      title: 'How Horizon seals facts',
      image: 'how.png',
...
**It ensures that, when examination is required, facts already exist.**`,
  ...
  fr: {
    ...
    problem: {
      title: 'Quand les faits ne peuvent plus être prouvés post-incident',
      intro: 'Pendant un incident majeur :',
      bullets: [
      ...
      questions_intro: 'Quelques semaines plus tard, les questions arrivent :',
      questions: [
      ...
      reconstruction: 'À ce moment-là, la réalité est reconstruite à partir d\'emails, de chats, de traces partielles et de mémoire humaine.',
      conclusion: 'Cette reconstruction est fragile.',
    },
    howHorizonWorks: {
      title: 'Comment Horizon scelle les faits',
      image: 'how.png',
