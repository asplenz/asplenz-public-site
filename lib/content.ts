    ...
    index: {
      ...
      pricing: {
        ...
        tiers: [
          ...
          { name: 'Business', price: '€899/mo', cta: 'Start with Business', features: ['50 scopes / 50 repos', 'Unlimited entries', 'Knowledge Verifier - fail-on-blocking + strict mode', 'Override lifecycle dashboard', 'Cross-scope visibility', 'Expiration alerts', 'Full event distribution', 'Role-based access', 'Advanced metrics & trend reports', 'Priority support'] },
          { name: 'Enterprise', price: 'Custom', cta: 'Contact Sales', features: ['Unlimited scopes & repos', 'Advanced governance analytics', 'Cross-scope enforcement policies', 'Evidence bridge', 'SSO & audit log', 'Dedicated support & onboarding', 'VPC / on-premise deployment (option)'] },
        ],
        verifierAddon: {
